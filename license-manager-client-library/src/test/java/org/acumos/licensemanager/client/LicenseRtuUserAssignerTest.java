 ...
 */
public class LicenseRtuUserAssignerTest {
  ...
  public void licenseCreator() throws RightToUseException {
    ...
    // // create
    // ILicenseAssigner licenseSrvc = new LicenseAssigner(client);
    // CreateRtuRequest licenseDownloadRequest = new CreateRtuRequest(solutionId, userId);
    // IAssignedRtuResponse verifyUserRTU = licenseSrvc.createRtu(licenseDownloadRequest);
    ...
    // IAssignedRtuResponse verifyUserRtu3 = licenseSrvc.createRtu(licenseDownloadRequest3);
